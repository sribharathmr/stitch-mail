    ...
    <>
      ...
      <aside className={`sidebar ${mobileMenuOpen ? 'mobile-open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/accounts" id="nav-accounts" className={({ isActive }) => `sidebar-nav-item ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
            <span className="nav-icon">🔄</span>
            <span className="nav-label">Unified Switcher</span>
          </NavLink>
          <NavLink to="/tree-view" id="nav-tree-view" className={({ isActive }) => `sidebar-nav-item ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
            <span className="nav-icon">🌳</span>
        ...
        <div className="sidebar-bottom">
          <NavLink to="/settings" id="nav-settings" className={({ isActive }) => `sidebar-nav-item ${isActive ? 'active' : ''}`} onClick={handleNavClick}>
